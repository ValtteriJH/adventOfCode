...
The newly-improved calibration document consists of lines of text; each line originally contained a specific
 calibration value that the Elves now need to recover. On each line, the calibration value can be found by combining the first digit 
...
'''
inStr = '''rhqrpdxsqhgxzknr2foursnrcfthree
2bmckl
four95qvkvveight5
...
# Replace all spelled out numbers with their end letters staying in tact, just the number typed out in the middle #

for index, line in enumerate(lines):
    line = str(line)
    for i in number_dict:
        line = line.replace(i,i[0]+str(number_dict[i])+i[-1])
